...
import ir.sadeghi.emulator.atm.dto.AuthenticationResult;
import ir.sadeghi.emulator.atm.dto.CheckingCardResult;
...
///checkCardNumber/{pan}
        ...
        if (c.getPreferredAuthentication().equals("FingerPring")) {
            ...
            AuthenticationResult result = restTemplate.postForObject(bankServiceUrl + "/authenticateWithPin", myJsonObject, AuthenticationResult.class);
            ...
            myJsonObject.put("pan", pan);
            myJsonObject.put("fingerPrint", secret);
            AuthenticationResult result = restTemplate.postForObject(bankServiceUrl + "/authenticateWithFingerPrint", myJsonObject, AuthenticationResult.class);
            if (result.isAuthenticated()){
                authentication.setAuthenticated(true);
                return authentication;
            }
